...
Analysis/bookkeeping/meta-process sessions are also exempt from Rule A mandatory parallel patterns, any zero-parallel failure rule, and the 5+ parallel-turns target; use only minimal evidence-gathering commands.
